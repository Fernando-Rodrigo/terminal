...
#pragma region ITerminalInput
    ...
    bool SendMouseEvent(const til::point viewportPos, const uint32_t uiButton, const ControlKeyStates states, const int32_t wheelDelta, const Microsoft::Console::VirtualTerminal::TerminalInput::MouseButtonState state) override;
    ...
    bool ShouldSendAlternateScroll(const uint32_t uiButton, const int32_t delta) const noexcept;
