...
// Return Value:
// - <none>
void Renderer::TriggerSystemRedraw(const til::rect& prcDirtyClient)
{
    FOREACH_ENGINE(pEngine)
    {
...
// Return Value:
// - <none>
void Renderer::TriggerRedraw(const til::point pcoord)
{
...
// Return Value:
// - <none>
void Renderer::TriggerRedrawCursor(const til::point pcoord)
{
...
// Return Value:
// - <none>
void Renderer::TriggerScroll(const til::point pcoordDelta)
{
    FOREACH_ENGINE(pEngine)
    {
