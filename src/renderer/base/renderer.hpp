...
namespace Microsoft::Console::Render
{
    ...
    public:
        ...
        void TriggerSystemRedraw(const til::rect& prcDirtyClient);
        void TriggerRedraw(const Microsoft::Console::Types::Viewport& region);
        void TriggerRedraw(const til::point pcoord);
        void TriggerRedrawCursor(const til::point pcoord);
        void TriggerRedrawAll();
        void TriggerTeardown() noexcept;

        void TriggerSelection();
        void TriggerScroll();
        void TriggerScroll(const til::point pcoordDelta);
