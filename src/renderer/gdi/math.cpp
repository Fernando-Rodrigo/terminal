...
{
    pRectExisting.left = std::min<LONG>(pRectExisting.left, pRectToOr.left);
    pRectExisting.top = std::min<LONG>(pRectExisting.top, pRectToOr.top);
    pRectExisting.right = std::max<LONG>(pRectExisting.right, pRectToOr.right);
    pRectExisting.bottom = std::max<LONG>(pRectExisting.bottom, pRectToOr.bottom);
}
