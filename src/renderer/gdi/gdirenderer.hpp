...
namespace Microsoft::Console::Render
{
    ...
    private:
        ...
        [[nodiscard]] HRESULT _InvalidCombine(const til::rect& prc) noexcept;
        [[nodiscard]] HRESULT _InvalidOffset(const til::point ppt) noexcept;
        [[nodiscard]] HRESULT _InvalidRestrict() noexcept;

        [[nodiscard]] HRESULT _InvalidateRect(const til::rect& prc) noexcept;
        ...
        void _OrRect(_In_ til::rect& pRectExisting, const til::rect& pRectToOr) const;
