...
public:
    ...
    void ProcessResizeWindow(const til::rect& prcClientNew, const til::rect& prcClientOld);
    void SetViewportSize(const til::size& pcoordSize);
...
private:
    ...
    [[nodiscard]] HRESULT _AdjustScreenBufferHelper(const til::rect& prcClientNew,
                                                    const til::size coordBufferOld,
                                                    _Out_ til::size* const pcoordClientNewCharacters);
    [[nodiscard]] HRESULT _AdjustScreenBuffer(const til::rect& prcClientNew);
    void _CalculateViewportSize(const til::rect& prcClientArea, _Out_ til::size* const pcoordSize);
    void _AdjustViewportSize(const til::rect& prcClientNew, const til::rect& prcClientOld, const til::size& pcoordSize);
    void _InternalSetViewportSize(const til::size& pcoordSize, const bool fResizeFromTop, const bool fResizeFromLeft);

    static void s_CalculateScrollbarVisibility(const til::rect& prcClientArea,
