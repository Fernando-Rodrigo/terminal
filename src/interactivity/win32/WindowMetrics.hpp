...
namespace Microsoft::Console::Interactivity::Win32
{
    ...
    public:
        ...
        til::rect GetMaxWindowRectInPixels(const til::rect& prcSuggested, _Out_opt_ UINT* pDpiSuggested);
        ...
        void ConvertClientRectToWindowRect(_Inout_ til::rect& prc);
        void ConvertWindowRectToClientRect(_Inout_ til::rect& prc);
    ...
    private:
        ...
        void ConvertRect(_Inout_ til::rect& prc, const ConvertRectangle crDirection);
    };
}
